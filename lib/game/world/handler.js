...
class WorldHandler extends _events2.default {
  ...
  changeMap(mapID) {
    _map_name2.default.mapId = mapID;
    _map2.default.load(mapID).then(map => {
      if (this.map) {
  ...
  animate(delta, camera, cameraMoved) {
    ...
    _blueprint2.default.animate(delta);
  }
