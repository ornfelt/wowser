...
var _bigInteger = require('jsbn/lib/big-integer');
...
class BigNum {
  ...
  constructor(value, radix) {
    if (typeof value === 'number') {
      this._bi = _bigInteger2.default.fromInt(value);
    } else if (value.constructor === _bigInteger2.default) {
      this._bi = value;
    } else if (value.constructor === BigNum) {
      this._bi = value.bi;
    } else {
      this._bi = new _bigInteger2.default(value, radix);
    }
  }
...
BigNum.ZERO = new BigNum(_bigInteger2.default.ZERO);
