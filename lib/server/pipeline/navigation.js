...
class Navigation {
  ...
  // Method to calculate a path
  static calculatePath(startX, startY, startZ, endX, endY, endZ) {
    ...
    try {
        //pathPtr = Navigation.NavigationLib.CalculatePath(1, start, end, false, lengthPtr);
        pathPtr = Navigation.NavigationLib.CalculatePath(0, start, end, false, lengthPtr);
