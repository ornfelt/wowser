...
class Navigation {
  ...
  static NavigationLib = new ffiNapi.Library(Navigation.libraryPath, {
    ...
    'MoveForwardWithParams': [XYZPtr, [uint32, float, float, float, float, float, float, float]],
  });
  ...
  static moveForward(mapId, startX, startY, startZ, angle, hoverHeight, objectSize, collisionHeight) {
