...
class WorldHandler extends EventEmitter {
  ...
  constructor(session) {
	...
	//this.player.worldport(209, 427.5, 604.1, 145.8); // Zul'Farrak (tanarisinstance)
	//this.player.worldport(289, 199.42, 126.46, 134.91); // Scholomance (schoolofnecromancy)
	//this.player.worldport(309, -11916.09, -1239.40, 92.28); // Zul'Gurub (zul'gurub.wdt)
	...
	//this.player.worldport(601, 413.314, 795.968, 831.351); // Azjol (azjol_uppercity)
